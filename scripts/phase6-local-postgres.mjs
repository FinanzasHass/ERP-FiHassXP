...
try{
 ...
 await mkdir('docs/fase-6',{recursive:true});
 const resultPath='docs/fase-6/resultado-postgres-local.json';
 await mkdir('docs/fase-6/historico',{recursive:true});
 try{const previous=await readFile(resultPath,'utf8');await writeFile('docs/fase-6/historico/postgres-'+Date.now()+'.json',previous);}catch(error){if(error.code!=='ENOENT')throw error;}
