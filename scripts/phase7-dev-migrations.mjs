...
const run=promisify(execFile),folder='docs/fase-7';
...
if(before.ok&&process.argv.includes('--apply')){
 ...
 if(listed.length<37||listed.some(r=>r.local!==r.remote&&!approved.includes(r.local)))throw new Error('Unexpected DEV migration drift');
