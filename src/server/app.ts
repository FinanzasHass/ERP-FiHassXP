...
export function createApp(config: RuntimeConfig, deps: Dependencies, clientDirectory = path.resolve('dist/client')) {
  ...
  app.get(['/', '/login', '/auth/callback', '/app', '/app/dashboard', '/app/companies', '/app/areas', '/app/positions', '/app/users', '/app/roles', '/app/audit', '/app/settings', '/app/cost-centers', '/app/projects', '/app/currencies', '/app/requests', '/app/approvals', '/app/suppliers', '/app/purchase-orders', '/app/service-acceptances', '/app/tax-documents', '/app/payables', '/app/payment-terms', '/app/approval-policies', '/app/bank-changes', '/app/supplier-contacts', '/app/reports', '/app/payment-orders','/app/payments','/app/payment-batches','/app/banks','/app/bank-accounts','/app/payment-methods','/app/bank-transactions','/app/reconciliation-periods','/app/reconciliation-matches','/app/treasury','/app/schedule','/app/cashflow','/app/travel-expenses','/app/expense-reports','/app/employee-advances','/app/expense-declarations','/app/employee-returns','/app/employee-reimbursements','/app/employee-expense-dashboard','/app/customers','/app/receivables','/app/collections','/app/collection-deposits','/app/receivable-schedules','/app/memberships','/app/lot-receivables','/app/issued-documents','/app/receivable-dashboard','/app/customer-credits','/app/future/:module'], (_req, res) => {
